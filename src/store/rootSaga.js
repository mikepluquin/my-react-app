...
import { authLoginInitSaga, authAutoLoginInitSaga, authRegisterInitSaga } from './auth/sagas'

export function *watchAuth(){
  yield all([
    takeLatest(authActionTypes.AUTH_LOGIN_INIT, authLoginInitSaga),
    takeLatest(authActionTypes.AUTH_AUTO_LOGIN_INIT, authAutoLoginInitSaga),
